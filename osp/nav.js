...
<div class="nav">
    <img src="../images/light-logo.png" class="brand-logo" alt="">
    <div class="nav-items">
    ...
    <div class="search">
        ...
        <div class="login-logout-popup hide">
            <p class="account-info1">welcome,</p>
                ...
                <li class="dd-item"><a href="#" class="link">women</a></li>
                 <li class="dd-item"><a href="#" class="link">men</a></li>
                 <li class="dd-item"><a href="#" class="link">kids</a></li>
                 <li class="dd-item"><a href="#" class="link">accessories</a></li>
                 <li class="dd-item"><a href="seller" class="link">Seller-Dash</a></li>
...
<div class="links-container">
    ...
    <li class="link-item"><a href="#" class="link">women</a>
        <ul class="dropdown-nav">
            <li><a href="#" class="aaa">Sub-1</a></li>
            <li><a href="#" class="aaa">Sub-2</a></li>
            <li><a href="#" class="aaa">Sub-3</a></li> 
            <li><a href="#" class="aaa">Sub-4</a></li>
            <li><a href="#" class="aaa">Sub-4</a></li>
            <li><a href="#" class="aaa">Sub-4</a></li>
        </ul>
    </li>
    <li class="link-item"><a href="#" class="link">men</a>
        <ul class="dropdown-nav">
            <li><a href="#" class="aaa">Sub-4</a></li>
            <li><a href="#" class="aaa">Sub-5</a></li>
            <li><a href="#" class="aaa">Sub-6</a></li>
            <li><a href="#" class="aaa">Sub-7</a></li>
            <li><a href="#" class="aaa">Sub-8</a></li>
            <li><a href="#" class="aaa">Sub-9</a></li>
        </ul>
    </li>
